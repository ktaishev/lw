...
void print_pipe_menu(void)
{
    std::cout << "1. Добавить трубу" << std::endl
        ...
        << "6. Напечатать выбранные трубы" << std::endl
        << "7. Поиск по параметру" << std::endl
        << "8. Изменение выбранных труб" << std::endl
        << "9. Сохранение в файл" << std::endl
        << "10. Загрузка из файла" << std::endl
        << "11. Помощь" << std::endl
...
void print_ks_menu(void)
{
    std::cout << "1. Добавить компрессорную станцию" << std::endl
        ...
        << "9. Изменение выбранных компрессорных станци " << std::endl
